...
<Cont width="w-90">
    ...
    <router-link to="/new-attendence" class="text-reset text-decoration-none"><h2 class="fs-6 mb-1 mt-2 text-end"><i class="fa fa-plus" aria-hidden="true"></i> Add New Attendence</h2></router-link>

    <h2 class="fs-1 mb-2 me-auto">Select Date</h2>
