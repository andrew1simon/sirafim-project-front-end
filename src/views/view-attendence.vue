        ...
        <select  class="form-select w-auto" @change="(e) => changeFilter(e)">
            ...
            <option value="قداس">قداس</option>
                ...
                <div v-if="!loading" class="d-flex justify-content-center flex-column">
                    <router-link v-for="date in filteredDates" :to="'/view-attendence-sing?date=' + date.date" class="text-reset text-decoration-none d-flex w-90 justify-content-center">
